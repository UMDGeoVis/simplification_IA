...
public:
    ...
    // static CompressedToExpandedLUT compressed_to_expanded;
    // static ExpandedToCompressedLUT expanded_to_compressed;
    // static unsigned int const NUM_TETRA_CASES = 51030;
